...
return [
    // branding
    ['name' => 'branding.site_description', 'value' => "Movies, the world's most popular and authoritative source for movie, TV and celebrity content."],
    ...
    ['name' => 'landing.appearance', 'value' => json_encode([
        ...
        'secondaryFeatures' => [
            ...
            [
                ...
                'description' => 'If you decide Movies isn\'t for you - no problem. No commitment. Cancel online at anytime.',
